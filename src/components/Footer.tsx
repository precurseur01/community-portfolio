...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: Linkedin, url: "https://linkedin.com/in/yndris-douanla-060968273", label: 'LinkedIn', key: 'LinkedIn', color: 'hover:text-primary' },
    ...
    <footer className="bg-card/80 backdrop-blur-xl border-t border-border text-foreground/70">
      <div className="relative py-20 overflow-hidden border-y border-border bg-gradient-to-br from-primary/5 via-background to-accent/5">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group bg-secondary/20 backdrop-blur-lg border border-border rounded-2xl p-6 hover:border-blue-500/40 transition duration-300 hover:-translate-y-2">
              <div className="text-primary text-3xl font-bold mb-4">01</div>
              <h4 className="text-foreground font-semibold mb-3">{t("footer.step1")}</h4>
              <p className="text-muted-foreground text-sm leading-relaxed">{t("footer.step1Desc")}</p>
            </div>
            <div className="group bg-secondary/20 backdrop-blur-lg border border-border rounded-2xl p-6 hover:border-emerald-500/40 transition duration-300 hover:-translate-y-2">
              <div className="text-accent text-3xl font-bold mb-4">02</div>
              <h4 className="text-foreground font-semibold mb-3">{t("footer.step2")}</h4>
              <p className="text-muted-foreground text-sm leading-relaxed">{t("footer.step2Desc")}</p>
            </div>
            <div className="group bg-secondary/20 backdrop-blur-lg border border-border rounded-2xl p-6 hover:border-blue-500/40 transition duration-300 hover:-translate-y-2">
              <div className="text-primary text-3xl font-bold mb-4">03</div>
              <h4 className="text-foreground font-semibold mb-3">{t("footer.step3")}</h4>
              <p className="text-muted-foreground text-sm leading-relaxed">{t("footer.step3Desc")}</p>
            </div>
            <div className="group bg-secondary/20 backdrop-blur-lg border border-border rounded-2xl p-6 hover:border-emerald-500/40 transition duration-300 hover:-translate-y-2">
              <div className="text-accent text-3xl font-bold mb-4">04</div>
              <h4 className="text-foreground font-semibold mb-3">{t("footer.step4")}</h4>
              <p className="text-muted-foreground text-sm leading-relaxed">{t("footer.step4Desc")}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Bloc 2 — Services */}
          <div>
            <h3 className="text-foreground font-semibold mb-5">{t("footer.services")}</h3>
            <ul className="space-y-3 text-sm">
              {serviceKeys.map((key, index) => (
                <li key={index}>
                  <a href="/services" className="hover:text-foreground transition">{t(key)}</a>
                </li>
              ))}
              <li className="pt-2 border-t border-border/50">
                <a href="/pricing" className="text-accent font-medium hover:text-accent/80 transition-colors flex items-center gap-2">
                  <Sparkles size={14} />
                  {t("nav.pricing")}
                </a>
              </li>
          ...
          {/* Bloc 3 — Contact */}
          <div>
            <h3 className="text-foreground font-semibold mb-5">{t("footer.contact")}</h3>
          ...
          <div>
            <h3 className="text-foreground font-semibold mb-5">{t("footer.why")}</h3>
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li className="flex items-center gap-2"><Rocket size={18} className="text-primary" /> {t("footer.why1")}</li>
              <li className="flex items-center gap-2"><TrendingUp size={18} className="text-primary" /> {t("footer.why2")}</li>
              <li className="flex items-center gap-2"><Target size={18} className="text-primary" /> {t("footer.why3")}</li>
              <li className="flex items-center gap-2"><Zap size={18} className="text-primary" /> {t("footer.why4")}</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="relative overflow-hidden border-b border-border">
        ...
        <div className="relative max-w-4xl mx-auto px-5 sm:px-8 py-16 text-center">
          ...
          {/* Titre émotionnel */}
          <h3 className="text-3xl sm:text-4xl font-bold text-foreground leading-tight mb-3">
          ...
          {/* Sous-titre */}
          <p className="text-muted-foreground text-base sm:text-lg max-w-xl mx-auto mb-2 leading-relaxed">
          ...
          >
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3.5 bg-secondary/30 border border-border rounded-xl text-foreground placeholder-muted-foreground text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all disabled:opacity-50"
              />
            </div>
          ...
          {/* Feedback messages */}
          {status === 'success' && (
            <p className="mt-4 text-sm text-accent flex items-center justify-center gap-2 animate-pulse">
              <Send size={14} />
      ...
      <div className="border-t border-border">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-6 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground text-center md:text-left">
          ...
          <div className="flex gap-6">
            ...
            <a href="/privacy-policy" className="hover:text-foreground transition">{t("footer.privacy")}</a>
          </div>
        </div>
      </div>
