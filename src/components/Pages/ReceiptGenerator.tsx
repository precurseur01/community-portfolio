...
const BlankReceipt: React.FC = () => {
  ...
  <div style={{
    ...
    {/* HEADER */}
    <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", borderBottom: "2.5px solid #0f3460", paddingBottom: "8px", gap: "12px" }}>
      <div style={{ display: "flex", alignItems: "center", gap: "10px", minWidth: "160px" }}>
        <img src={Img.logo} style={{ height: "14mm", objectFit: "contain" }} alt="Free Digital Solutions" />
        <div>
          <div style={{ fontSize: "7.5pt", color: "#555", lineHeight: 1.4 }}>Agence Digitale</div>
          <div style={{ fontSize: "6.5pt", color: "#888", lineHeight: 1.5 }}>digital.freedry.dev<br />+237 670 616 710</div>
        </div>
      </div>
      <div style={{ textAlign: "center", flex: 1 }}>
        <div style={{ fontSize: "13pt", fontWeight: 800, color: "#0f3460", textTransform: "uppercase" as const, letterSpacing: "0.5px" }}>REÇU DE PAIEMENT – FORMATION</div>
        <div style={{ fontSize: "9pt", color: "#16a34a", fontWeight: 600, marginTop: "3px", lineHeight: 1.5 }}>
          Marketing Digital &amp; Community Management
        </div>
      </div>
      <div style={{ minWidth: "130px", textAlign: "right", fontSize: "8pt" }}>
        <div style={{ color: "#888", fontSize: "7pt" }}>N° Reçu</div>
        ...
        <div style={{ color: "#888", fontSize: "7pt", marginTop: "4px" }}>Date</div>
        <div><BL w="70px" /></div>
      </div>
    </div>

    {/* INFOS CLIENT */}
    <div style={{ display: "flex", gap: "20px", background: "#f8faff", border: "1px solid #dde3f0", borderRadius: "4px", padding: "5px 10px" }}>
      <div style={{ fontSize: "8.5pt", color: "#555", flex: 1 }}>Participant : <BL w="130px" /></div>
      <div style={{ fontSize: "8.5pt", color: "#555" }}>Téléphone : <BL w="100px" /></div>
    </div>
    ...
    <div style={{ display: "flex", gap: "12px" }}>
      <table style={{ width: "58%", borderCollapse: "collapse", fontSize: "9pt" }}>
        <thead>
          <tr>
            <th colSpan={2} style={{ background: "#0f3460", color: "#fff", padding: "4px 8px", textAlign: "left", fontSize: "7pt", letterSpacing: "0.5px", textTransform: "uppercase" as const }}>
        ...
        <tbody>
          <tr style={{ background: "#f0f4ff" }}>
            <td style={{ border: "1px solid #dde3f0", padding: "5px 8px", color: "#0f3460" }}>Montant Total Formation</td>
            <td style={{ border: "1px solid #dde3f0", padding: "5px 8px", fontWeight: 700, color: "#0f3460" }}><BL w="80px" /> FCFA</td>
          </tr>
          <tr>
            <td style={{ border: "1px solid #dde3f0", padding: "5px 8px", color: "#16a34a" }}>Total Payé</td>
            <td style={{ border: "1px solid #dde3f0", padding: "5px 8px", fontWeight: 700, color: "#16a34a" }}><BL w="80px" /> FCFA</td>
          </tr>
          <tr style={{ background: "#fff0f3" }}>
            <td style={{ border: "1px solid #f5c6cc", padding: "5px 8px", color: "#e94560", fontWeight: 700 }}>Reste à Payer</td>
            <td style={{ border: "1px solid #f5c6cc", padding: "5px 8px", fontWeight: 800, color: "#e94560" }}><BL w="80px" /> FCFA</td>
          </tr>
        </tbody>
      </table>
      <div style={{ flex: 1, border: "1px solid #dde3f0", borderRadius: "5px", padding: "7px 10px", display: "flex", flexDirection: "column" as const, justifyContent: "space-between" }}>
        <div style={{ fontSize: "7pt", color: "#888", textTransform: "uppercase" as const, fontWeight: 600 }}>Signature &amp; Cachet</div>
        <div style={{ flex: 1, marginTop: "4px", border: "1.5px dashed #c5cde8", borderRadius: "4px", minHeight: "44px" }} />
        <div style={{ fontSize: "6.5pt", color: "#aaa", marginTop: "4px", textAlign: "center" as const }}>Signature autorisée</div>
      </div>
    </div>

    {/* MONTANT EN LETTRES */}
    <div style={{ background: "#f0f4ff", border: "1px solid #c5cde8", borderRadius: "4px", padding: "6px 10px", display: "flex", alignItems: "center", gap: "10px", flexWrap: "wrap" as const }}>
      <div>
        <span style={{ fontSize: "7.5pt", color: "#888" }}>Montant payé ce jour (FCFA) : </span>
        <span style={{ fontWeight: 800, color: "#0f3460", fontSize: "11pt" }}><BL w="80px" /></span>
      </div>
  ...
  <div style={{
    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "10px", minWidth: "160px" }}>
        ...
        <div>
          <div style={{ fontSize: "7.5pt", color: "#555", lineHeight: 1.4 }}>Agence Digitale</div>
          <div style={{ fontSize: "6.5pt", color: "#888", lineHeight: 1.5 }}>
      ...
      <div style={{ minWidth: "110px", textAlign: "right", fontSize: "8pt" }}>
        <div style={{ color: "#888", fontSize: "7pt" }}>N° Reçu</div>
        <div style={{ fontWeight: 700, color: "#0f3460", fontSize: "8.5pt" }}>{data.numero}</div>
        <div style={{ color: "#888", fontSize: "7pt", marginTop: "4px" }}>Date</div>
        <div style={{ fontWeight: 600, color: "#1a1a2e" }}>{data.date}</div>
      </div>
    </div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "24px" }}>
          <div>
            ...
            <div style={{ fontSize: "12px", color: "#888", marginTop: "3px" }}>
              Marketing Digital &amp; Community Management — Remplissez les champs pour générer le reçu
            </div>
          </div>
          <button
        ...
        <div style={{ display: "flex", gap: "12px", marginTop: "22px", flexWrap: "wrap" }}>
          <button onClick={handlePrint} style={{ ...btnBase, background: "#0f3460", color: "#fff" }}>
            Imprimer
          </button>
          <button onClick={downloadPDF} style={{ ...btnBase, background: "#e94560", color: "#fff" }}>
            Télécharger PDF
          </button>
          <button
